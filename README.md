...
This repository contains the Admin Dashboard for the GPT-Line system.
...
This repository is responsible only for the Admin service and should not redefine cross-service contracts on its own.